...
export async function getPageChunks({userId,pdfId,pages}: PageChunkProps) : Promise<PageChunkResult[]> {
...
export async function getAllChunks({userId,pdfId}:FullPDFChunkProps): Promise<PageChunkResult[]> {
...
// const res = await getPageChunks({userId : "abc1001" , pdfId : "1001" , pages : [1,2,3]})
// console.log(res)